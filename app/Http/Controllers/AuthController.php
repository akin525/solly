...
//        Alert::info('Sollyinstantawoof', 'Data Refill | Airtime | Cable TV | Electricity Subscription');
        Alert::image('Sollyinstantawoof!','Data Refill | Airtime | Cable TV | Electricity Subscription','https://realinstant.com.ng/df.jpeg','200','200', 'Image Alt');
...
//            $wallet = wallet::where('username', $user->username)->get();
        ...
        if ($time < "12") {
            ...
            return  view('dashboard', compact('user', 'charge',  'greet', 'totaldeposite', 'me', 'deposite',  'bil2', 'bill', 'totalrefer', 'count'));
