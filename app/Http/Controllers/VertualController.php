    ...
    public function vertual(Request $request)
    {
        if (Auth::check()) {
            ...
            curl_setopt_array($curl, array(
                ...
                CURLOPT_POSTFIELDS => array('account_name' => $name, 'business_short_name' => 'sollyinstantawoof', 'uniqueid' => $username, 'email' => $email, 'phone' => $phone, 'webhook_url' => 'https://realinstant.com.ng/api/run',),
