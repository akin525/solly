...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" type="image/png" sizes="16x16" href="https://realinstant.com.ng/fd.jpg">
        <!-- Custom CSS -->
...
<script>
    ...
    <a href="http:wa.me/2349135185582/?text=Goodday, My Username is....." class="float" target="_blank">
