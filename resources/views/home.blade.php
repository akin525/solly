...
<head>
    ...
    <!-- Favicons -->
    <link href="https://realinstant.com.ng/fd.jpg" rel="icon">
    <link href="https://realinstant.com.ng/fd.jpg" rel="apple-touch-icon">
...
<header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <div class="logo">
            <h1 class="text-light"><a href="{{route('home')}}"><span>Sollyinstantawoof</span></a></h1>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 content">
                    <h3><strong>About Sollyinstantawoof</strong></h3>
                    <p class="fst-italic">
                        With Sollyinstantawoof, you can purchase your airtime, data, electricity bills and TV subscription with just the click of a button, all by yourself, seamlessly and without stress. We operate a 24/7 days support system with prompt response to any complains or suggestion from our esteemed clients.
                    </p>
                ...
                <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
                    ...
                    <div class="accordion-list">
                        <ul>
                            ...
                            <li>
                                <a data-bs-toggle="collapse" data-bs-target="#accordion-list-3" class="collapsed"><span>03</span> What are the services available on the Sollyinstantawoof? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
...
<footer id="footer">
    ...
    <div class="container">
        <div class="copyright">
            &copy; Copyright <strong><span>Sollyinstantawoof</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
